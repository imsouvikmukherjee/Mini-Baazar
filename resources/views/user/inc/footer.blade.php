                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            ...
                            47 Subhash Avenue nearby municipality opposite LIC office Ranaghat. Nadia. West Bengal
                            pin: 741201

                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Phone: </strong> 8101504680
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Email: </strong>
                            info@minibaazar.in
                        ...
                        <div class="mobile-social-icon wow fadeIn animated mb-sm-5 mb-md-0">
                            <a href="#"><img
                                    src="{{ asset('front_assets/imgs/theme/icons/icon-facebook.svg') }}"
                                    alt=""></a>
                            <a href="#"><img
                                    src="{{ asset('front_assets/imgs/theme/icons/icon-twitter.svg') }}"
                                    alt=""></a>
                            <a href="#"><img
                                    src="{{ asset('front_assets/imgs/theme/icons/icon-instagram.svg') }}"
                                    alt=""></a>
                            <a href="#"><img
                                    src="{{ asset('front_assets/imgs/theme/icons/icon-pinterest.svg') }}"
                                    alt=""></a>
                            <a href="#"><img
                                    src="{{ asset('front_assets/imgs/theme/icons/icon-youtube.svg') }}"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="download-app wow fadeIn animated mob-app">
                                <a href="#" class="hover-up mb-sm-4 mb-lg-0">
                                    <a href="#" class="hover-up"><img
                                            src="{{ asset('front_assets/imgs/theme/google-play.jpg') }}"
                                            alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                            ...
                            <img class="wow fadeIn animated"
                                src="{{ asset('front_assets/imgs/theme/payment-method.png') }}"
                                alt="">
                        </div>
                    </div>
                </div>
